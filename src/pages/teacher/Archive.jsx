    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Arsip Sesi</h1>
        </div>
        <p className="text-gray-500 mt-1">Sesi pembelajaran yang sudah selesai</p>
      </div>
      ...
      {archivedSessions.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-600">Belum Ada Arsip</h3>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="badge bg-gray-100 text-gray-500 text-[10px]">Selesai</span>
                  </div>
